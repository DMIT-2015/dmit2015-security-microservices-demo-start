 ...
 *
 ...
 curl -i -X GET http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems

 curl -i -X GET http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems/1
 ...
 curl -i -X GET http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems/4

 curl -i -X PUT http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems/4 \
    -d '{"id":4,"name":"Demo DMIT2015 Assignment 1","complete":true}' \
    -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems/4

 curl -i -X DELETE http://localhost:8080/dmit2015-security-microservices-demo-start/webapi/TodoItems/4
